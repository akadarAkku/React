...
test("Renders 3 articles when given 3 articles", async () => {
    ...
    const elements = await ("news-article");
...
test("Renders articles with title ", async () => {
    ...
    const article1 = await ("10 Amazing Things you did not know about React");
    const article2 = await ("Discover the Best Javascript Framework");
    const article3 = await ("This simple trick will teach you everything about React");
...
test("Passing functions as props ", async () => {
    ...
    expect(element.innerHTML)==("Reading all article will take you 1 minutes");});
   ...
   test("Passing functions as props: part 2", async () => {
    ...
    const element = await ("reading-length");
    ...
    expect(element.innerHTML)==("Reading all article will take you 2 minutes");
});
